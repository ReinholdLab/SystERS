  ...
  R6::R6Class(
    ...
    public =
      list(
        ...
        #' @param field_capacity The max volume of water in the cell.
        #' @param cell_storage The volume of water already in the cell.
        ...
        initialize =
          function(..., input){
            ...
            self$spill_over <- (self$input + self$cell_storage) - self$field_capacity
          },
