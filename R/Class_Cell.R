...
#' @title Class Cell_Water_Soil_SAS (R6) Soil cell
#' @description Instantiate a soil cell. Inherits from class
#'   \code{\link{Cell_Water}}.
#' @importFrom R6 R6Class
#' @export

Cell_Water_Soil_SAS <- R6::R6Class(
  classname = "Cell_Water_Soil_SAS",
  ...
  public = list(
    ...
    #' @field cellSoilType The soil type of the cell. For notation purposes only.
    cellSoilType = NULL,
    #' @field cellWaterAge The ages of water within the cell.
    cellWaterAge = NULL,
